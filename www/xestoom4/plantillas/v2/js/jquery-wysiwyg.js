...
(function( $ )
{
    ...
    $.extend(Wysiwyg, {
        ...
        TOOLBAR : {
            ...
            pmozilla  : { visible : true && $.browser.mozilla, className : 'p' , command : 'heading', arguments : ['p'] , tags : ['p'] },
            ...
            h4 : { visible : true && !( $.browser.mozilla ), className : 'h4', command : 'formatBlock', arguments : ['h4'], tags : ['h4'] },
