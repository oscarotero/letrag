...
?>
	...
	<head>
		<title><?php print($v_textos['cabeceira']['titulo']); ?></title>
		...
		<script type="text/javascript" src="<?php print($rutas['xw_js']); ?>javascript-respostas.js"></script>
		...
		<link type="text/css" rel="stylesheet" href="<?php print($rutas['xw_css']); ?>estilos-respostas.css" media="screen" />
	</head>